...
main(int argc, char *argv[])
{
    ...
    do {
        ...
        // lets try the local library directory next, this is the path within the
        ...
        qDebug() << "Athlete to open: " + (!athleteToOpen.toString().isEmpty() ? athleteToOpen.toString() : QString("No - Fault in athlete processing"));
